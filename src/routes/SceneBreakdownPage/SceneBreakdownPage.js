        ...
        <>
          ...
          <main>
            ...
            <section className="element-section">
              ...
              <h3>Cast</h3>
              <ul className="element-section">
                {cast.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Extras</h3>
              <ul className="element-section">
                {extras.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Greenery</h3>
              <ul className="element-section">
                {greenery.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Livestock</h3>
              <ul className="element-section">
                {livestock.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Makeup/Hair</h3>
              <ul className="element-section">
                {makeupHair.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Mechanical FX</h3>
              <ul className="element-section">
                {mechanicalFx.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Miscellaneous</h3>
              <ul className="element-section">
                {miscellaneous.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Music</h3>
              <ul className="element-section">
                {music.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Optical FX</h3>
              <ul className="element-section">
                {opticalFx.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Props</h3>
              <ul className="element-section">
                {props.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Security</h3>
              <ul className="element-section">
                {security.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Set Dressing</h3>
              <ul className="element-section">
                {setDressing.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Sound</h3>
              <ul className="element-section">
                {sound.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Special Equipment</h3>
              <ul className="element-section">
                {specialEquipment.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Special FX</h3>
              <ul className="element-section">
                {specialFx.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Stunts</h3>
              <ul className="element-section">
                {stunts.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Vehicles</h3>
              <ul className="element-section">
                {vehicles.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>

              <h3>Visual FX</h3>
              <ul className="element-section">
                {visualFx.map((element) => <li className="element-tag" key={element.id}>{element.description}</li>)}
              </ul>
